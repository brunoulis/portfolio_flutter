  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      themeMode: themeProvider.isDarkMode ? ThemeMode.dark : ThemeMode.light,
          theme: ThemeData(
            colorScheme: ColorScheme.light(), // Aquí puedes definir tu esquema de color claro
          ),
          darkTheme: ThemeData(
            colorScheme: ColorScheme.dark(), // Aquí puedes definir tu esquema de color oscuro
          ),
      theme: ThemeData(
        useMaterial3: true,
